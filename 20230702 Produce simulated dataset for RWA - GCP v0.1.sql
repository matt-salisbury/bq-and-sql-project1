...
SELECT
  *
  ...
  AVG(t1.TURNOVER_LATEST, t1.TURNOVER_1YR_PRIOR, t1.TURNOVER_2YR_PRIOR) < 44000000) THEN 1
  ...
  t8.ST_EXPOSURE_CLASS_USES_CQS_IND = 1 AND t1.ECAI_RATING_GRADE = 'No Rating Available' THEN t4.CQS END AS CQS
